export type ThinBidPath = 'cash_out' | 'gold_fade' | 'twap_lock' | 'last_minute' | 'step_buy' | 'spike_fade' | 'pair_lock';

const PATH_FLAG: Record<
  ThinBidPath,
  | 'cash_out_skip_thin_bid'
  | 'gold_fade_skip_thin_bid'
  | 'twap_lock_skip_thin_bid'
  | 'last_minute_skip_thin_bid'
  | 'step_buy_skip_thin_bid'
  | 'spike_fade_skip_thin_bid'
  | 'pair_lock_skip_thin_bid'
> = {
  ...
  step_buy: 'step_buy_skip_thin_bid',
  spike_fade: 'spike_fade_skip_thin_bid',
  pair_lock: 'pair_lock_skip_thin_bid',
};
