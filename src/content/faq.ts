      ...
      items: [
        {
          ...
          a:
            ...
            'After Start after and before Flatten left, Cloud buys the cheaper YES or NO if that ask is at or under Cheap max, the YES/NO gap is at least Min gap, and |live − strike| is at least Min live $ (default $25; 0 = off). Size is Lot contracts × live ask — not Auto $5. Example: YES 30¢ and NO 70¢ → buy YES. 49¢ / 51¢ sits out. A $5 BTC drift with a 30¢ ticket also sits until live has moved Min live $.\n\n' +
